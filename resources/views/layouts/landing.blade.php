...
<head>
    ...
    <meta name="description"
        content="Sistem Informasi Penanganan Penghentian Penuntutan Berdasarkan Keadilan Restoratif
    " />
    ...
    <meta property="og:title"
        content="SIPRAKTIF - Sistem Informasi Penanganan Penghentian Penuntutan Berdasarkan Keadilan Restoratif" />
                ...
                <div class="auto-container">
                    <div class="inner-container clearfix">
                        ...
                        <div class="top-left">
                            <!-- Info List -->
                            <ul class="info-list">
                                <li><a href="mailto:kt.bengkulu@kejaksaan.go.id"><span
                                            class="icon icofont-envelope"></span> kt.bengkulu@kejaksaan.go.id</a></li>
                                <li><a href="tel:07367345695"><span class="icon icofont-phone"></span> (0736)
                                        7345695</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="inner-container clearfix">
                        ...
                        <div class="pull-left logo-box">
                            <div class="logo"><a href="{{ route('index') }}"><img
                                        src="{{ asset('assets-landing/images/logo.png') }}" alt=""
                                        title=""></a></div>
                        </div>
                                        ...
                                        <li class="dropdown"><a href="#">Monitoring Perkara</a>
                                            <ul>
                                                @foreach ($divisi as $data)
                                                    <li><a href="{{ Route('dataPerkara', ['id' => $data->id]) }}">Satuan
                                                            Kerja {{ $data->name }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                        ...
                        <div class="outer-box">
                            <!-- Search Btn -->
                            <div class="search-box-btn search-box-outer"><span class="icon icofont-search"></span>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-lg-12 col-md-12 col-sm-12">
                                    <div class="contact-map-area">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3981.056523362744!2d102.26470187601497!3d-3.7978444435314938!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e36b017e4245713%3A0x9760bb3b8083bf55!2sJl.%20S.%20Parman%20Kejaksaan%20Tinggi%20No.2%2C%20Tanah%20Patah%2C%20Kec.%20Ratu%20Agung%2C%20Kota%20Bengkulu%2C%20Bengkulu%2038222!5e0!3m2!1sid!2sid!4v1718932098571!5m2!1sid!2sid"
                                ...
                                <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                    <div class="footer-widget newsletter-widget">
                                        ...
                                        <div class="row" style="margin: 10px 0px">
                                            ...
                                            <div class="col-3 d-flex justify-content-center">
                                                <a href=""><i class="bi bi-youtube"
                                                        style="font-size: 24px"></i></a>
                                            </div>
                                            <div class="row mt-5">
                                                <ul class="list-link">
                                                    <li><a href="https://maps.app.goo.gl/7F5JgjfyWHKh8qgW9"
                                                            target="_blank"> <i class="bi bi-pin-map-fill"
                                                                style="font-size: 24px"></i> Jl. S. Parman Kejaksaan
                                                            Tinggi No.2, Tanah Patah, Kec. Ratu Agung, Kota Bengkulu,
                                                            Bengkulu 38222</a></li>
                                                    <li><a href="tel:07367345695"><i class="bi bi-telephone"
                                                                style="font-size: 24px"></i> (0736) 7345695</a></li>
                                                    <li><a href="mailto:kt.bengkulu@kejaksaan.go.id"><i
                                                                class="bi bi-envelope" style="font-size: 24px"></i>
                                                            kt.bengkulu@kejaksaan.go.id</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- Newsletter Form -->
                                ...
                                <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                    <div class="footer-widget links-widget">
                                        ...
                                        <ul class="list-link">
                                            ...
                                            <li><a href="">Kejari Kepahiang</a></li>
                                            <li><a href="">Kejari Lebong</a></li>
                                            <li><a href="">Kejari Seluma</a></li>
                                            <li><a href="">Kejari Bengkulu Utara</a></li>
